      ...
      <div className="container-fluid py-5">
        <div className="row g-4">
          ...
          <div className="col-lg-4 col-md-6">
            <div className="d-flex align-items-center mb-3">
              ...
              />
              <div>
                <h5 style={{ color: 'var(--construction-gold)', fontWeight: '700', marginBottom: '0' }}>Buildex</h5>
                <small style={{ fontSize: '0.7rem', color: 'var(--section-divider)' }}>Building Your Dreams</small>
              </div>
            </div>
            <p style={{ color: 'var(--section-divider)', fontSize: '0.9rem', lineHeight: '1.6' }}>
            ...
            <div className="social-links mt-3">
              <a href="#" className="me-3" style={{ color: 'var(--construction-gold)', fontSize: '1.5rem', transition: 'all 0.3s ease' }}
              ...
              <a href="#" style={{ color: 'var(--construction-gold)', fontSize: '1.5rem', transition: 'all 0.3s ease' }}
                onMouseEnter={(e) => e.target.style.color = '#E6C86E'}
                onMouseLeave={(e) => e.target.style.color = 'var(--construction-gold)'}
              >
          ...
          <div className="col-lg-2 col-md-6">
            <h6 style={{ color: 'var(--construction-gold)', fontWeight: '600', marginBottom: '1rem', fontSize: '1rem' }}>Quick Links</h6>
            <ul style={{ listStyle: 'none', padding: 0 }}>
              <li className="mb-2">
                <button 
                  onClick={() => navigateTo('home')}
                  className="btn btn-link p-0 text-decoration-none"
                  style={{ color: 'var(--section-divider)', fontSize: '0.9rem', transition: 'all 0.3s ease' }}
          ...
          <div className="col-lg-3 col-md-6">
            ...
            <ul style={{ listStyle: 'none', padding: 0 }}>
              <li className="mb-2" style={{ color: 'var(--section-divider)', fontSize: '0.9rem' }}>
          ...
          <div className="col-lg-3 col-md-6">
            ...
            <ul style={{ listStyle: 'none', padding: 0 }}>
              <li className="mb-3 d-flex align-items-start">
                ...
                <span style={{ color: 'var(--section-divider)', fontSize: '0.9rem' }}>
              ...
              <li className="mb-3 d-flex align-items-center">
                ...
                <span style={{ color: 'var(--section-divider)', fontSize: '0.9rem' }}>+91 9913191735</span>
              </li>
              <li className="mb-3 d-flex align-items-center">
                <i className="bi bi-envelope-fill me-2" style={{ color: 'var(--construction-gold)', fontSize: '1.1rem' }}></i>
                <span style={{ color: 'var(--section-divider)', fontSize: '0.9rem' }}>info@buildex.com</span>
              </li>
              <li className="mb-3 d-flex align-items-center">
                <i className="bi bi-clock-fill me-2" style={{ color: 'var(--construction-gold)', fontSize: '1.1rem' }}></i>
                <span style={{ color: 'var(--section-divider)', fontSize: '0.9rem' }}>Mon - Sat: 9:00 AM - 6:00 PM</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="row mt-4 pt-4" style={{ borderTop: '1px solid rgba(200, 162, 74, 0.2)' }}>
          <div className="col-md-6 text-center text-md-start mb-3 mb-md-0">
            <p style={{ color: 'var(--section-divider)', fontSize: '0.85rem', marginBottom: '0' }}>
              © {currentYear} Buildex. All rights reserved. | Built with excellence for builders and buyers.
            </p>
          </div>
          <div className="col-md-6 text-center text-md-end">
            <a href="#" className="me-3 text-decoration-none" style={{ color: 'var(--section-divider)', fontSize: '0.85rem', transition: 'all 0.3s ease' }}
              onMouseEnter={(e) => e.target.style.color = 'var(--construction-gold)'}
              onMouseLeave={(e) => e.target.style.color = 'var(--section-divider)'}
            >
              Privacy Policy
            </a>
            <a href="#" className="me-3 text-decoration-none" style={{ color: 'var(--section-divider)', fontSize: '0.85rem', transition: 'all 0.3s ease' }}
            ...
            <a href="#" className="text-decoration-none" style={{ color: 'var(--section-divider)', fontSize: '0.85rem', transition: 'all 0.3s ease' }}
              onMouseEnter={(e) => e.target.style.color = 'var(--construction-gold)'}
              onMouseLeave={(e) => e.target.style.color = 'var(--section-divider)'}
            >
              Sitemap
