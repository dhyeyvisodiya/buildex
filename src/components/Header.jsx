            ...
            <div className={`collapse navbar-collapse ${isMenuOpen ? 'show' : ''}`} id="navbarNav">
              ...
              <ul className="navbar-nav">
                ...
                {currentUser && currentUser.role === 'admin' && (
                  <li className="nav-item dropdown">
                    <button 
                      className="nav-link dropdown-toggle btn btn-link text-decoration-none ms-2" 
                      data-bs-toggle="dropdown"
                      style={{ color: 'rgba(255, 255, 255, 0.9)' }}
                    >
                      Dashboards
                    ...
                    <ul className="dropdown-menu dropdown-menu-end animate__animated animate__fadeIn">
                      <li>
                        <button 
                          className="dropdown-item" 
                          onClick={() => {navigateTo('user-dashboard'); setIsMenuOpen(false);}}
                          style={{ transition: 'all 0.2s ease' }}
                          onMouseEnter={(e) => e.target.style.backgroundColor = 'rgba(255, 255, 255, 0.1)'}
                          onMouseLeave={(e) => e.target.style.backgroundColor = 'transparent'}
                        >
                      ...
                      <li>
                        <button 
                          className="dropdown-item" 
                          onClick={() => {navigateTo('builder-dashboard'); setIsMenuOpen(false);}}
                          style={{ transition: 'all 0.2s ease' }}
                          onMouseEnter={(e) => e.target.style.backgroundColor = 'rgba(255, 255, 255, 0.1)'}
                          onMouseLeave={(e) => e.target.style.backgroundColor = 'transparent'}
                        >
                      ...
                      <li>
                        <button 
                          className="dropdown-item" 
                          onClick={() => {navigateTo('admin-dashboard'); setIsMenuOpen(false);}}
                          style={{ transition: 'all 0.2s ease' }}
                          onMouseEnter={(e) => e.target.style.backgroundColor = 'rgba(255, 255, 255, 0.1)'}
                          onMouseLeave={(e) => e.target.style.backgroundColor = 'transparent'}
                        >
